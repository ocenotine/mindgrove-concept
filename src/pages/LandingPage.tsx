  ...
  return (
    <div className="relative h-screen min-h-[600px] max-h-[800px] flex items-center overflow-hidden">
      <div 
        ...
        style={{ 
          backgroundImage: "url('/lovable-uploads/200d90ba-4083-4422-9ddd-e9cadebc6cc3.png')",
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl">
          ...
          >
            Unlock your academic potential with AI-powered study tools designed for students, researchers, and educators
          </motion.p>
          <motion.div 
        ...
        <main>
            ...
            <div className="container mx-auto px-6 py-12">
              <div className="bg-gradient-to-r from-primary/90 to-secondary/90 rounded-2xl p-8 flex items-center justify-between">
                <div className="space-y-4 flex-1">
                  <h2 className="text-3xl font-bold text-white">Try the MindGrove Companion App</h2>
          ...
          <section className="py-20 bg-muted/30">
            <div className="container mx-auto px-6">
              <h2 className="text-3xl font-bold text-center mb-12">Stay Motivated with Gamification</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  {
                    title: "Streak Tracking",
                    description: "Build consistent study habits by maintaining your daily streaks"
                  },
                  {
                    title: "Leaderboard",
                  ...
                  {
                    title: "Achievements",
                    description: "Earn badges and celebrate your academic milestones"
                  }
                ].map((feature, index) => (
                  <motion.div
                    key={index}
          ...
          <section className="py-20 bg-muted/30">
            <div className="container mx-auto px-6">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold mb-4">🚀 Have an idea for MindGrove?</h2>
